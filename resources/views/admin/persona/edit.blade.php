                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="dirección"  class="@error('dirección') is-invalid @enderror col-sm-12  form-control input-lg" placeholder="Ingresar direccion" value="{{$persona->des_direc}}" minlength="5" maxlength="255">
                                                    @error('dirección')
                                                        <div class="invalid-feedback">
