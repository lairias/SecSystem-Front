                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class = "select2 @error('codigo_persona') is-invalid @enderror col-md-12 form-control" name="codigo_persona" id="post-codigo_persona">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="fec_ini_contrato" value="{{old('fec_ini_contrato')}}" id="post-fec_ini_contrato" class="@error('fec_ini_contrato') is-invalid @enderror col-sm-12 form-control input-lg"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="fec_fin_contrato" value="{{old('fec_fin_contrato')}}" id="post-fec_fin_contrato" class="@error('fec_fin_contrato') is-invalid @enderror col-sm-12 form-control  input-lg"
                                                    data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask>
...
@section('js')
    ...
    <script>
        ...
        $('.toastrDefaultSuccess').click(function() {
            toastr.success('Registro de empleado en proceso.')
        });
