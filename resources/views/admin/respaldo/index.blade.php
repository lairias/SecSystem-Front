            ...
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <a href="http://localhost:3000/api/respaldo">
                    ...
                    <div class="card card-warning">
                        ...
                        <form id='formSQL' method="POST" action="http://localhost:3000/api/respaldo/upload" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
...
@section('js')
        ...
        <!-- <script>
            ...
            subir_archivo.addEventListener('change', e => {
                ...
                fetch('http://localhost:3000/api/respaldo/upload', {
                    method: 'POST',
                    headers: {
            ...
            //     xhr.open('POST', 'http://localhost:3000/api/respaldo/upload');
            //     xhr.send(fd);
            // });
        </script> -->
